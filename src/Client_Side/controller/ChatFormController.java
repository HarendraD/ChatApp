...
public class ChatFormController extends Thread {
    ...
    public AnchorPane chatControllerPane;
        ...
        try {
            if (imageFilePath != null) {
                ...
                if (msg != null) {
                     ...
                     objectOutputStream.writeObject(new Message(ClientLoginFormController.userName, "", imageFilePath));
                     objectOutputStream.flush();
                }
            } else {
                try {
                    if (msg != null) {
                         ...
                         objectOutputStream.writeObject(new Message(ClientLoginFormController.userName, "", null));
                         objectOutputStream.flush();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void fileChooserOnClick(MouseEvent mouseEvent) {
        ...
        File file = fileChooser.showOpenDialog(chatControllerPane.getScene().getWindow());
